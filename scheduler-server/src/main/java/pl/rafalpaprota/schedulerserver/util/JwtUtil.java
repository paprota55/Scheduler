package pl.rafalpaprota.schedulerserver.util;
...
public class JwtUtil {
    ...
    public String generateToken(final Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS256, this.SIGNING_KEY)
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + this.ACCESS_TOKEN_VALIDITY_SECONDS * 1000))
                .compact();
    }
    ...
    public UsernamePasswordAuthenticationToken getAuthentication(final String token, final Authentication existingAuth, final UserDetails userDetails) {
        ...
        final JwtParser jwtParser = Jwts.parser().setSigningKey(this.SIGNING_KEY);
